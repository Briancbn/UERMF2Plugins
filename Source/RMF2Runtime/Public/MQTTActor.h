...
public:
  ...
  UFUNCTION(
      BlueprintCallable,
      Category = "MQTT|Connection",
      meta =
          (DisplayName = "Connect to MQTT Broker",
           Keywords = "mqtt connect broker")
  )
  ...
  UFUNCTION(
      ...
      Category = "MQTT|Connection",
      meta =
          (DisplayName = "Disconnect from MQTT Broker",
           Keywords = "mqtt disconnect")
  )
  ...
  UFUNCTION(
      ...
      Category = "MQTT|Connection",
      meta =
          (DisplayName = "Is MQTT Connected",
           Keywords = "mqtt connected status")
  )
  ...
  UFUNCTION(
      ...
      meta =
          (DisplayName = "Publish MQTT Message",
           Keywords = "mqtt publish send message")
  )
  ...
  /// \param Topic - Topic to subscribe to (can include wildcards like
  /// "home/+/temperature") \param QoS - Quality of Service level \return True
  /// if subscription was successful
  UFUNCTION(
      BlueprintCallable,
      Category = "MQTT|Messaging",
      meta =
          (DisplayName = "Subscribe to MQTT Topic",
           Keywords = "mqtt subscribe topic")
  )
  ...
  UFUNCTION(
      ...
      Category = "MQTT|Messaging",
      meta =
          (DisplayName = "Unsubscribe from MQTT Topic",
           Keywords = "mqtt unsubscribe")
  )
  ...
  UFUNCTION(
      ...
      Category = "MQTT|Messaging",
      meta =
          (DisplayName = "Has MQTT Messages", Keywords = "mqtt message pending")
  )
  ...
  UFUNCTION(
      ...
      Category = "MQTT|Messaging",
      meta =
          (DisplayName = "Get Next MQTT Message",
           Keywords = "mqtt receive message")
  )
  ...
  static int
  OnMessageArrived(void* Context, char* TopicName, int TopicLen, void* Message);
...
private:
  ...
  /// \param Context User-defined context passed to the MQTT client.
  /// \param Cause Null-terminated string describing the reason for the
  /// disconnect.
