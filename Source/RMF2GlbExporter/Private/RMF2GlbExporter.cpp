...
void FRMFGlbSceneExporterModule::RegisterMenus()
{
  ...
  Section.AddMenuEntry(
      ...
      LOCTEXT(
          "RMFOpenGLBExportFolderTooltip",
          "Opens the GLB export output folder."
      ),
      FSlateIcon(),
      FUIAction(FExecuteAction::CreateRaw(
          this,
          &FRMFGlbSceneExporterModule::OpenExportFolder
      ))
  );
}
...
void FRMFGlbSceneExporterModule::RunExportScript()
{
  TSharedPtr<IPlugin> Plugin =
      IPluginManager::Get().FindPlugin(TEXT("RMFGlbSceneExporter"));
